...
ent-CrateTechBoardRandom = ящик с запасными платами
    .desc = Откуда-то взялись эти лишние платы.
ent-CrateRPD = ящик с РПД
    .desc = Ящик, содержащий одно быстродействующее трубопроводное устройство.
ent-CrateEngineeringFirefighterBackpackTank = ящик пожаротушения
    .desc = Содержит ранцевую емкость для воды для тушения пожаров.
ent-CrateAirGrenade = ящик гранат с воздухом
    .desc = Ящик, содержащий три гранаты с воздухом.
